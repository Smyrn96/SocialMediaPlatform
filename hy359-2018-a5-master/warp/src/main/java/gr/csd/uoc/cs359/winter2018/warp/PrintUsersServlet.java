 ...
 * @author internet
 */
@WebServlet(name = "PrintUsersServlet", urlPatterns = {"/PrintUsersServlet"})
public class PrintUsersServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             out.print("<h2>Users List:</h2><br>"+ "<h5>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PrintUsersServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
